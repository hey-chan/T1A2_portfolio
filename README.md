...
**Navigation bar**
Underlines current page, and shows underline for other item when hovered over
![screenshot-nav](docs/nav_current_hover.png)

**Footer**
Icons will change colour when hovered over
![screenshot-iconhover](docs/nav_current_hover.png)
